<%-- 
    ...
    Created on : Aug 21, 2020, 10:41:22 AM
    Author     : Bhatti
--%>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="text-uppercase font-weight-bold">
                                <th scope="row"><%=c.getC_id()%></th>
                                <td ><%=c.getC_name()%></td>
                                <td><%=c.getC_description()%></td>
                                <td><a class="btn btn-warning font-weight-bold btn-lg" href="updatecategory?id=<%=c.getC_id()%>">Update</a></td>
                                <td><a class="btn btn-danger font-weight-bold btn-lg" href="deletecategory?id=<%=c.getC_id()%>">Delete</a></td>
